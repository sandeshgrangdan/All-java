...
public class updatedata extends javax.swing.JDialog {
     ...
     */
    public updatedata(java.awt.Frame parent, boolean modal,ArrayList data ) {
        super(parent, modal);
        initComponents();
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            java.util.Date s,d;
        try {
            s = sdf.parse(data.get(4).toString());
            ustartdate.setDate(s);
            d = sdf.parse(data.get(5).toString());
            ulastadate.setDate(d);
            
        } catch (ParseException ex) {
            Logger.getLogger(updatedata.class.getName()).log(Level.SEVERE, null, ex);
        }
        ustarttime.setText(data.get(6).toString());
        uendtime.setText(data.get(7).toString());
        
        sdays.setText(data.get(8).toString());
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(ulecture)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(ufaculty, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(37, 37, 37)
                            .addComponent(jLabel4)
                            .addGap(18, 18, 18)
                            .addComponent(usection, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                .addComponent(ustartdate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel5)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ulastadate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(uendtime, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(sdays, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))
       ...
       DateFormat df = new SimpleDateFormat("YYYY-MM-dd");
        if (!"".equals(this.ulecture.getText())) {
            if (this.ustartdate.getDate() != null && this.ulastadate.getDate() != null) {
                if ((validdate(df.format(this.ustartdate.getDate())))
                        && (validdate(df.format(this.ulastadate.getDate())))) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                updatedata dialog = new updatedata(new javax.swing.JFrame(), true , null);
